...
import com._ToTanKhai.Lab7_4.Lab74Application;
...
public class Lab74Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		showStudents();
		List<Student> studentList = studentService.findStudentAgeGreaterThanEqual(19);
		
		System.out.println("Student with age greater than or qual 19:");

		
		showStudentList(studentList);
		System.out.println("The number of students with Ielts score of 5.0 is" + studentService.countStudentWithIeltsScore(5.0));
		studentList = studentService.searchStudentByName("Khai");
